...
class RegistrationPersonalDataViewController: UIViewController {
	...
	private lazy var personalCodeTextField: UITextField = self.initTextField(image: UIImage(named: "password")!, placeholder: self.viewModel.personalCode, isInputSecured: true)
	private lazy var documentNumberTextField: UITextField = self.initTextField(image: UIImage(named: "passport")!, placeholder: self.viewModel.documentNumber, isInputSecured: true)
