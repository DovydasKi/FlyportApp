//
//  PassportControlViewController.swift
//  FlyportApp
//
...
public class PassportControlViewController: UIViewController {
	...
	private lazy var registrationTableTitle: UILabel = self.initSimpleLabel(title: self.viewModel.yourPassportControlTable)
...
extension PassportControlViewController {
	...
	private func initIcon() -> UIImageView {
		let image = #imageLiteral(resourceName: "PassportControl")
		let imageView = UIImageView(image: image)
		imageView.translatesAutoresizingMaskIntoConstraints = false
