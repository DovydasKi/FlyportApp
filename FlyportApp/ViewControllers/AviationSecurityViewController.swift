//
//  AviationSecurityViewController.swift
//  FlyportApp
//
...
public class AviationSecurityViewController: UIViewController {
	...
	private lazy var aviationSecurityTableTitle: UILabel = self.initSimpleLabel(title: self.viewModel.yourAviationSecurityTable)
...
extension AviationSecurityViewController {
	...
	private func initIcon() -> UIImageView {
		let image = #imageLiteral(resourceName: "SecurityPoint")
		let imageView = UIImageView(image: image)
		imageView.translatesAutoresizingMaskIntoConstraints = false
